        ...
        <form id="product_profile" class="w-full flex flex-col md:flex-row justify-center items-start gap-5 my-12" enctype="multipart/form-data">
            ...
            <div class="bg-white flex flex-col gap-4 p-5 rounded-lg shadow-lg w-full md:w-4/12 lg:w-3/12 xl:w-2/12">
                ...
                <div class="mx-auto size-full p-2">
                    <img src="<?= $product->image ?>" alt="Imagen de perfil" class="object-cover rounded-lg shadow-lg">
                </div>
            ...
            <div class="bg-white p-5 rounded-lg shadow-lg flex flex-col gap-4 w-full md:w-6/12 xl:w-5/12">   
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select name="category" id="category" class="w-full border rounded-lg py-1 px-3" disabled>
                        ...
                        <option value="4" <?= $product->category_id == '4' ? 'selected' : '' ?>>Otros</option>
                    </select>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select name="state" id="state" class="w-full border rounded-lg py-1 px-3" disabled>
                        <option value="public" <?= $product->state == 'public' ? 'selected' : '' ?>>Public</option>
                        <option value="private" <?= $product->state == 'private' ? 'selected' : '' ?>>Private</option>
                    </select>
                </div>
                ...
                <span class="w-full flex justify-between items-center">
                    ...
                    <div class="flex gap-5">
                        <?= $_SESSION['role_id'] == 3 ? '<a href="/page/dashboard_products" class="bg-violet-800 text-white py-2 px-4 rounded-md mt-auto w-max font-bold"> Administrador </a>' : '' ?>
                    </div>
                </span>
            </div>
        </form>
