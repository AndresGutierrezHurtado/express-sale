        ...
        <form id="product_profile_form" class="w-full flex flex-col md:flex-row justify-center items-start gap-5 my-12" enctype="multipart/form-data">
            ...
            <div class="bg-white p-5 rounded-lg shadow-lg flex flex-col gap-4 w-full md:w-6/12 xl:w-5/12">   
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" id="name" name="name" value="<?= $product['product_name']; ?>" class="w-full border rounded-lg py-1 px-3" disabled>
                </div> 

                <div class="flex flex-col gap-1">
                    <label for="description" class="text-md font-medium text-gray-700">Descripción:</label>
                    <textarea id="description" name="description" class="w-full h-24 resize-none border rounded-lg py-1 px-3" disabled><?= $product['product_description']; ?></textarea>
                </div>

                <div class="flex flex-col gap-1">
                    <label for="price" class="text-md font-medium text-gray-700">Precio:</label>
                    <input type="text" id="price" name="price" value="<?= $product['product_price']; ?>" class="w-full border rounded-lg py-1 px-3" disabled>
                </div>

                <div class="flex flex-col gap-1">
                    <label for="stock" class="text-md font-medium text-gray-700">Stock:</label>
                    <input type="text" id="stock" name="stock" value="<?= $product['product_stock']; ?>" class="w-full border rounded-lg py-1 px-3" disabled>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <select name="state" id="state" class="w-full border rounded-lg py-1 px-3" disabled>
