    ...
    <div class="w-5/12 mx-auto py-8">
        <div class="bg-white p-8 rounded-md shadow-md">
            ...
            <div class="class flex flex-col gap-2 mb-5  ">
                ...
                <a href="/page/order_receipt_pdf/?id=<?= $delivery['order_id'] ?>" target="_blank" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded inline-block w-fit">
