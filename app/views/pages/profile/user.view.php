...
<body class="w-full min-h-screen bg-gray-50">
    ...
    <main class="w-full flex flex-col gap-10 py-12 justify-center items-center container mx-auto px-5">
        ...
        <form id="user_profile_form" class="w-full flex flex-col md:flex-row justify-between items-start gap-5" enctype="multipart/form-data">
            ...
            <!-- Image container -->
            <div class="bg-white flex flex-col gap-4 p-5 rounded-lg shadow-lg w-full w-full md:max-w-[350px] mx-auto">
                ...
                <div class="w-full aspect-square overflow-hidden rounded-md shadow-lg">
                    <img src="<?= $user['image_url'] ?>" alt="foto <?= $user['user_first_name'] ?>"
                ...
                <button id="btn-edit" class="text-violet-800 border-2 border-violet-800 py-2 px-4 rounded-md mt-auto w-max font-bold cursor-pointer">
                <i class="fa-solid fa-pen mr-2"></i>
                    Editar
                </button>
                <a class="bg-violet-800 text-white py-2 px-4 rounded-md mt-auto w-max font-bold cursor-pointer" id="btn-logout">
            ...
            <div class="bg-white p-5 rounded-lg shadow-lg flex flex-col gap-4 w-full md:max-w-[1fr]">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" id="full_name" name="user_first_name" value="<?= $user['user_first_name']; ?>" 
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" id="full_name" name="user_last_name" value="<?= $user['user_last_name']; ?>" 
                    class="w-full border rounded-lg py-1 px-3" disabled>
                </div>

                <div class="flex flex-col gap-1">
                    <label for="username" class="text-md font-medium text-gray-700">Nombre de Usuario:</label>
                    <input type="text" id="username" name="user_username" value="<?= $user['user_username']; ?>" 
                    class="w-full border rounded-lg py-1 px-3" disabled>
                </div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" id="address_input" name="user_address" value="<?= $user['user_address']; ?>" 
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="number" id="phone_number" name="user_phone_number" value="<?= $user['user_phone_number']; ?>" 
                    class="w-full border rounded-lg py-1 px-3" disabled>
                </div>
                ...
                <?php if ($user['user_role_id'] == 2 || $user['user_role_id'] == 3):?>
                    <div class="flex flex-col gap-1">
                        ...
                        class="h-24 w-full border rounded-lg py-1 px-3 resize-none" disabled> 
                            <?= $user['worker_description'] ?> 
                        </textarea>
                    </div>
                <?php endif; ?>
                    ...
                    <table class="w-full table-auto border-collapse border border-gray-900 text-[13px] sm:text-[16px] text-center max-w-full" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="hidden lg:table-cell"><?= $product['product_name']; ?></td>
                                <td ><?= number_format($product['product_price']); ?> COP</td>
                                <td class="hidden sm:table-cell"><?= $product['product_stock']; ?></td>
