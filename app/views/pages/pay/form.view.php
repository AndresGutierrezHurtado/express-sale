<form id="paymentForm" action="<?= PAYU_REQUEST_URI ?>" method="post"
    ...
    <div class="w-full space-y-2">
        ...
        <textarea id="order_message" name="order_message" placeholder="Notas adicionales como casa, conjunto, apartamento/persona. 

Ejemplo: Conjunto El ensueño, Torre 14, apto 104 | Andrés Hurtado"
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        icon: "error",
                        title: "Error",
                        text: "Hubo un error al guardar los datos: ".data.error,
