        ...
        <>
                    ...
                    <div className="space-y-2">
                        <div className="w-full flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    onClick={() => document.getElementById(`product-modal-${product.producto_id}`).show()}
            ...
            <dialog id={`product-modal-${product.producto_id}`} className="modal my-0_!important">
                <div className="modal-box rounded-lg">
                    ...
                    <form action="/calification/rate" method="post" encType="multipart/form-data" className="fetch-form space-y-2">
                        <input type="hidden" name="usuario_id" defaultValue={userSession && userSession.usuario_id} />
                        <input type="hidden" name="producto_id" defaultValue={product.producto_id} />
                        <input type="hidden" name="tipo_objeto" defaultValue="producto" />
                        ...
                        <label className="form-control w-full">
                            ...
                            <textarea placeholder="Ingresa un comentario sobre el producto." id="calificacion_comentario" name="calificacion_comentario"
                                className="textarea textarea-bordered h-24 resize-none focus:outline-0 focus:border-violet-600 rounded"></textarea>
                        </label>
                        ...
                        <div className="rating flex justify-center gap-2 py-3">
                            <input type="radio" name="calificacion" value="1" className="mask mask-star-2 bg-violet-600" defaultChecked />
                            <input type="radio" name="calificacion" value="2" className="mask mask-star-2 bg-violet-600" />
                            <input type="radio" name="calificacion" value="3" className="mask mask-star-2 bg-violet-600" />
                            <input type="radio" name="calificacion" value="4" className="mask mask-star-2 bg-violet-600" />
                            <input type="radio" name="calificacion" value="5" className="mask mask-star-2 bg-violet-600" />
                        </div>
                        <button type="submit" className="w-full bg-violet-600 font-bold duration-300 hover:bg-violet-800 text-white py-2 px-4 rounded-lg">Calificar</button>
                    </form>
                </div>
